 ...
 *  の責任を負わない．
 * 
 *  $Id: out.c 65 2020-02-04 09:07:13Z fujisft-shigihara $
 */
#include <kernel.h>
#include <t_syslog.h>
...
#ifndef TTSP_FMP
extern const size_t   _kernel_istksz;
extern STK_T *const _kernel_istk;
#else
extern const size_t   _kernel_istksz_table[TNUM_PRCID];
...
void task1(intptr_t exinf){
	...
	syslog_0(LOG_NOTICE,"ASP_staticAPI_DEF_ICS_d_1_1: Start");
	...
	syslog_0(LOG_NOTICE,"ASP_staticAPI_DEF_ICS_d_1_1: OK");
