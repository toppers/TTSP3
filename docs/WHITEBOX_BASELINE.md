...
```
分岐カバレッジ(kernel/): 1362/1405 = 96.9%  (C1, 2026-06-08 最終)
...
| task_term.c | 93/94 98.9% | 63 | 64 | 98.4% ◀ |
...
| **TOTAL** | **2428/2451 99.1%** | **1362** | **1405** | **96.9%** |
...
> 分岐 C1: 63/64 = 98.4%（残 1 箇所: `ras_ter` L180 br[0]、dispatch不要パス、到達不能）

| API | 行 C0 | 分岐 C1 | 未到達 | W |
|---|---|---|---|---|
| `ext_tsk` | 100% | 10/10 100% | — | — |
| `ras_ter` ◀ | 100% | 23/24 95.8% | 1 | L（到達不能） |
| `dis_ter` | 100% | 4/4 100% | — | — |
| `ena_ter` | 100% | 8/8 100% | — | — |
| `sns_ter` | 100% | 4/4 100% | — | — |
