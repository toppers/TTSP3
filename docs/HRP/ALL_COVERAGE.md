...
| domain.c | 127/187 67.9% | 40 | 90 | 44.4% ◀ *(M1-SOM: 6.7%→。chg_som/get_som/scyc/twd)* |
...
| sys_manage.c | 258/267 96.6% | 155 | 202 | 76.7% ◀ *(M4-b1-b3: 52.5%→。mget/mrot クローン+E_PAR/E_MACV)* |
...
| **HRP（zybo）** | **90.8%（2205/2429）** | 本ファイル（M2/M3/M4/M6+M1(SOM) 反映後。着手前 82.0%） |
