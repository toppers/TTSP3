...
/* 【TTSP3向け改変 2026-06-14・HRMP版】HRP 同様、保護カーネルの cfg 生成経路で out.h が
 * 多重展開され enum/宣言が再定義になるためインクルードガードを追加． */
...
/* 【TTSP3向け改変 2026-06-14・HRMP版】inthdr/isr の extern を無条件化（HRP 同様、cfg 由来の
 * kernel_cfg.c が INTNO 未定義文脈で out.h を取り込むため）． */
