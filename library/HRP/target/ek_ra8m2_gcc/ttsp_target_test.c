...
/*
 *		ターゲット依存のテストサポート関数（EK-RA8M2 / Cortex-M85 用）
 *
 *  [改変] 2026-06-19: zybo_z7_gcc 版（A-profile / GIC / MPCore グローバルタイマ）を
 *  ベースに，M-profile（ARMv8.1-M / Cortex-M85 / EK-RA8M2）向けに新規作成した．
