 ...
 *  の責任を負わない．
 * 
 *  $Id: ttsp_target_test.h 77 2020-03-24 10:03:29Z ertl-komori $
 */

/*
 *		テストプログラムのチップ依存定義（LPC55S69用）
 */
 ...
 *  割込み番号(異常値)
 */
#define TTSP_INVALID_INTNO  168	/* ターゲットでサポートしていない割込み番号 */
#define TTSP_NOT_SET_INTNO  46	/* 割込み要求ラインに対して割込み属性が設定されていない割込み番号 */
 ...
 *  　以下の変換マクロが必要
 */
#define ttsp_target_get_stksz(p_tinib)  ((size_t)((p_tinib)->tskinictxb.stk_bottom) - (size_t)((p_tinib)->tskinictxb.stk_top))
