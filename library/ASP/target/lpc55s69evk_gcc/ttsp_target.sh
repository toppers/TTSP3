...
#  の責任を負わない．
# 
#  $Id: ttsp_target.sh 77 2020-03-24 10:03:29Z ertl-komori $
# 
...
#
KERNEL_COBJS_TARGET="objs/core_kernel_impl.o objs/target_kernel_impl.o objs/target_timer.o objs/ttsp_target_test.o"
APPL_COBJS_TARGET=
