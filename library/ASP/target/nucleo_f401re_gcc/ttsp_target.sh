...
#
KERNEL_COBJS_TARGET="objs/core_kernel_impl.o objs/target_kernel_impl.o objs/target_timer.o objs/ttsp_target_test.o objs/system_stm32f4xx.o objs/stm32f4xx_nucleo.o objs/systemclock_config.o objs/stm32f4xx_hal_gpio.o objs/stm32f4xx_hal_uart.o objs/stm32f4xx_hal_rcc.o objs/stm32f4xx_hal_dma.o objs/stm32f4xx_hal_tim.o"
APPL_COBJS_TARGET=
