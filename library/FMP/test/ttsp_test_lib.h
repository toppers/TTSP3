...
#define TTSP_MACT_TSK(tskid, prcid)						mact_tsk((tskid), (prcid))
#define TTSP_MIG_TSK(tskid, prcid)						mig_tsk((tskid), (prcid))
#define TTSP_LOC_SPN(spnid)								loc_spn(spnid)
#define TTSP_UNL_SPN(spnid)								unl_spn(spnid)
