...
#define TTSP_FN_CHECK_FINISH		(TTSP_FN_BASE + 1)
#define TTSP_FN_BARRIER_SYNC		(TTSP_FN_BASE + 2)
#define TTSP_FN_MP_CHECK_POINT		(TTSP_FN_BASE + 3)
#define TTSP_FN_MP_WAIT_CHECK_POINT	(TTSP_FN_BASE + 4)
#define TTSP_FN_MP_CHECK_FINISH		(TTSP_FN_BASE + 5)
#define TTSP_FN_STATE_SYNC			(TTSP_FN_BASE + 6)
#define TTSP_FN_WAIT_FINISH_SYNC	(TTSP_FN_BASE + 7)
#define TTSP_FN_VALUE_SYNC			(TTSP_FN_BASE + 8)
#define TTSP_FN_STOP_TICK			(TTSP_FN_BASE + 9)
#define TTSP_FN_START_TICK			(TTSP_FN_BASE + 10)
#define TTSP_FN_GAIN_TICK			(TTSP_FN_BASE + 11)
#define TTSP_FN_INT_RAISE			(TTSP_FN_BASE + 12)
#define TTSP_FN_CPUEXC_RAISE		(TTSP_FN_BASE + 13)
#define TTSP_FN_REF_TSK				(TTSP_FN_BASE + 14)
#define TTSP_FN_REF_LOC_MTX			(TTSP_FN_BASE + 15)
#define TTSP_FN_REF_ALM				(TTSP_FN_BASE + 16)
#define TTSP_FN_REF_CYC				(TTSP_FN_BASE + 17)
#define TTSP_FN_REF_DTQ				(TTSP_FN_BASE + 18)
#define TTSP_FN_REF_DATA			(TTSP_FN_BASE + 19)
#define TTSP_FN_REF_SWAIT_DTQ		(TTSP_FN_BASE + 20)
#define TTSP_FN_REF_RWAIT_DTQ		(TTSP_FN_BASE + 21)
#define TTSP_FN_REF_PDQ				(TTSP_FN_BASE + 22)
#define TTSP_FN_REF_PRI_DATA		(TTSP_FN_BASE + 23)
#define TTSP_FN_REF_SWAIT_PDQ		(TTSP_FN_BASE + 24)
#define TTSP_FN_REF_RWAIT_PDQ		(TTSP_FN_BASE + 25)
#define TTSP_FN_REF_SPN				(TTSP_FN_BASE + 26)
#define TTSP_FN_REF_SEM				(TTSP_FN_BASE + 27)
#define TTSP_FN_REF_WAIT_SEM		(TTSP_FN_BASE + 28)
#define TTSP_FN_REF_MPF				(TTSP_FN_BASE + 29)
#define TTSP_FN_REF_WAIT_MPF		(TTSP_FN_BASE + 30)
#define TTSP_FN_REF_FLG				(TTSP_FN_BASE + 31)
#define TTSP_FN_REF_RWAIT_FLG		(TTSP_FN_BASE + 32)
#define TTSP_FN_REF_MTX				(TTSP_FN_BASE + 33)
#define TTSP_FN_REF_WAIT_MTX		(TTSP_FN_BASE + 34)
#define TTSP_FN_REF_MBF				(TTSP_FN_BASE + 35)
#define TTSP_FN_REF_MBF_MSG			(TTSP_FN_BASE + 36)
#define TTSP_FN_REF_SWAIT_MBF		(TTSP_FN_BASE + 37)
#define TTSP_FN_REF_RWAIT_MBF		(TTSP_FN_BASE + 38)
#define TTSP_FN_GET_IPM				(TTSP_FN_BASE + 39)
#define TTSP_FN_SET_TIM				(TTSP_FN_BASE + 40)
#define TTSP_FN_GET_TIM				(TTSP_FN_BASE + 41)
#define TTSP_FN_SUS_TSK				(TTSP_FN_BASE + 42)
#define SVC_FN_ADJ_TIM				(TTSP_FN_BASE + 43)
#define SVC_FN_SET_TIM				(TTSP_FN_BASE + 44)
#define SVC_FN_GET_TIM				(TTSP_FN_BASE + 45)
#define SVC_FN_STA_ALM				(TTSP_FN_BASE + 46)
#define SVC_FN_STP_ALM				(TTSP_FN_BASE + 47)
#define SVC_FN_REF_ALM				(TTSP_FN_BASE + 48)
#define SVC_FN_STA_CYC				(TTSP_FN_BASE + 49)
#define SVC_FN_STP_CYC				(TTSP_FN_BASE + 50)
#define SVC_FN_REF_CYC				(TTSP_FN_BASE + 51)
#define SVC_FN_DIS_INT				(TTSP_FN_BASE + 52)
#define SVC_FN_ENA_INT				(TTSP_FN_BASE + 53)
#define SVC_FN_RAS_INT				(TTSP_FN_BASE + 54)
#define SVC_FN_CLR_INT				(TTSP_FN_BASE + 55)
#define SVC_FN_PRB_INT				(TTSP_FN_BASE + 56)
#define SVC_FN_LOC_CPU				(TTSP_FN_BASE + 57)
#define SVC_FN_UNL_CPU				(TTSP_FN_BASE + 58)
#define SVC_FN_DIS_DSP				(TTSP_FN_BASE + 59)
#define SVC_FN_ENA_DSP				(TTSP_FN_BASE + 60)
#define SVC_FN_CHG_IPM				(TTSP_FN_BASE + 61)
#define SVC_FN_GET_IPM				(TTSP_FN_BASE + 62)
#define SVC_FN_ROT_RDQ				(TTSP_FN_BASE + 63)
#define SVC_FN_GET_LOD				(TTSP_FN_BASE + 64)
#define SVC_FN_GET_NTH				(TTSP_FN_BASE + 65)
#define SVC_FN_ACT_TSK				(TTSP_FN_BASE + 66)
#define SVC_FN_CAN_ACT				(TTSP_FN_BASE + 67)
#define SVC_FN_CHG_PRI				(TTSP_FN_BASE + 68)
#define SVC_FN_GET_PRI				(TTSP_FN_BASE + 69)
#define SVC_FN_GET_TST				(TTSP_FN_BASE + 70)
#define SVC_FN_REF_TSK				(TTSP_FN_BASE + 71)
#define SVC_FN_WUP_TSK				(TTSP_FN_BASE + 72)
#define SVC_FN_CAN_WUP				(TTSP_FN_BASE + 73)
#define SVC_FN_SUS_TSK				(TTSP_FN_BASE + 74)
#define SVC_FN_RSM_TSK				(TTSP_FN_BASE + 75)
#define SVC_FN_REL_WAI				(TTSP_FN_BASE + 76)
#define SVC_FN_TER_TSK				(TTSP_FN_BASE + 77)
#define SVC_FN_RAS_TER				(TTSP_FN_BASE + 78)
#define SVC_FN_DIS_TER				(TTSP_FN_BASE + 79)
#define SVC_FN_ENA_TER				(TTSP_FN_BASE + 80)
#define SVC_FN_WAI_SEM				(TTSP_FN_BASE + 81)
#define SVC_FN_POL_SEM				(TTSP_FN_BASE + 82)
#define SVC_FN_TWAI_SEM				(TTSP_FN_BASE + 83)
#define SVC_FN_SIG_SEM				(TTSP_FN_BASE + 84)
#define SVC_FN_INI_SEM				(TTSP_FN_BASE + 85)
#define SVC_FN_REF_SEM				(TTSP_FN_BASE + 86)
#define SVC_FN_WAI_FLG				(TTSP_FN_BASE + 87)
#define SVC_FN_POL_FLG				(TTSP_FN_BASE + 88)
#define SVC_FN_TWAI_FLG				(TTSP_FN_BASE + 89)
#define SVC_FN_SET_FLG				(TTSP_FN_BASE + 90)
#define SVC_FN_CLR_FLG				(TTSP_FN_BASE + 91)
#define SVC_FN_INI_FLG				(TTSP_FN_BASE + 92)
#define SVC_FN_REF_FLG				(TTSP_FN_BASE + 93)
#define SVC_FN_SND_DTQ				(TTSP_FN_BASE + 94)
#define SVC_FN_PSND_DTQ				(TTSP_FN_BASE + 95)
#define SVC_FN_TSND_DTQ				(TTSP_FN_BASE + 96)
#define SVC_FN_FSND_DTQ				(TTSP_FN_BASE + 97)
#define SVC_FN_RCV_DTQ				(TTSP_FN_BASE + 98)
#define SVC_FN_PRCV_DTQ				(TTSP_FN_BASE + 99)
#define SVC_FN_TRCV_DTQ				(TTSP_FN_BASE + 100)
#define SVC_FN_INI_DTQ				(TTSP_FN_BASE + 101)
#define SVC_FN_REF_DTQ				(TTSP_FN_BASE + 102)
#define SVC_FN_SND_PDQ				(TTSP_FN_BASE + 103)
#define SVC_FN_PSND_PDQ				(TTSP_FN_BASE + 104)
#define SVC_FN_TSND_PDQ				(TTSP_FN_BASE + 105)
#define SVC_FN_RCV_PDQ				(TTSP_FN_BASE + 106)
#define SVC_FN_PRCV_PDQ				(TTSP_FN_BASE + 107)
#define SVC_FN_TRCV_PDQ				(TTSP_FN_BASE + 108)
#define SVC_FN_INI_PDQ				(TTSP_FN_BASE + 109)
#define SVC_FN_REF_PDQ				(TTSP_FN_BASE + 110)
#define SVC_FN_LOC_MTX				(TTSP_FN_BASE + 111)
#define SVC_FN_PLOC_MTX				(TTSP_FN_BASE + 112)
#define SVC_FN_TLOC_MTX				(TTSP_FN_BASE + 113)
#define SVC_FN_UNL_MTX				(TTSP_FN_BASE + 114)
#define SVC_FN_INI_MTX				(TTSP_FN_BASE + 115)
#define SVC_FN_REF_MTX				(TTSP_FN_BASE + 116)
#define SVC_FN_SND_MBF				(TTSP_FN_BASE + 117)
#define SVC_FN_TSND_MBF				(TTSP_FN_BASE + 118)
#define SVC_FN_RCV_MBF				(TTSP_FN_BASE + 119)
#define SVC_FN_TRCV_MBF				(TTSP_FN_BASE + 120)
#define SVC_FN_INI_MBF				(TTSP_FN_BASE + 121)
#define SVC_FN_GET_MPF				(TTSP_FN_BASE + 122)
#define SVC_FN_PGET_MPF				(TTSP_FN_BASE + 123)
#define SVC_FN_TGET_MPF				(TTSP_FN_BASE + 124)
#define SVC_FN_REL_MPF				(TTSP_FN_BASE + 125)
#define SVC_FN_INI_MPF				(TTSP_FN_BASE + 126)
#define SVC_FN_REF_MPF				(TTSP_FN_BASE + 127)
#define SVC_FN_EXT_KER				(TTSP_FN_BASE + 128)
#define SVC_FN_MSTA_ALM				(TTSP_FN_BASE + 129)
#define SVC_FN_MSTA_CYC				(TTSP_FN_BASE + 130)
#define SVC_FN_MGET_LOD				(TTSP_FN_BASE + 131)
#define SVC_FN_MGET_NTH				(TTSP_FN_BASE + 132)
#define SVC_FN_MACT_TSK				(TTSP_FN_BASE + 133)
#define SVC_FN_MIG_TSK				(TTSP_FN_BASE + 134)
#define SVC_FN_LOC_SPN				(TTSP_FN_BASE + 135)
#define SVC_FN_TRY_SPN				(TTSP_FN_BASE + 136)
#define SVC_FN_UNL_SPN				(TTSP_FN_BASE + 137)
#define SVC_FN_REF_SPN				(TTSP_FN_BASE + 138)
...
#define TTSP_MSTA_ALM(almid, almtim, prcid)						cal_svc(SVC_FN_MSTA_ALM, (almid), (almtim), (prcid), 0, 0)
#define TTSP_MSTA_CYC(cycid, prcid)								cal_svc(SVC_FN_MSTA_CYC, (cycid), (prcid), 0, 0, 0)
#define TTSP_MGET_LOD(schedno, tskpri, p_load)					cal_svc(SVC_FN_MGET_LOD, (schedno), (tskpri), (intptr_t)(p_load), 0, 0)
#define TTSP_MGET_NTH(schedno, tskpri, nth, p_tskid)			cal_svc(SVC_FN_MGET_NTH, (schedno), (tskpri), (nth), (intptr_t)(p_tskid), 0)
#define TTSP_MACT_TSK(tskid, prcid)								cal_svc(SVC_FN_MACT_TSK, (tskid), (prcid), 0, 0, 0)
#define TTSP_MIG_TSK(tskid, prcid)								cal_svc(SVC_FN_MIG_TSK, (tskid), (prcid), 0, 0, 0)
#define TTSP_LOC_SPN(spnid)										cal_svc(SVC_FN_LOC_SPN, (spnid), 0, 0, 0, 0)
#define TTSP_TRY_SPN(spnid)										cal_svc(SVC_FN_TRY_SPN, (spnid), 0, 0, 0, 0)
#define TTSP_UNL_SPN(spnid)										cal_svc(SVC_FN_UNL_SPN, (spnid), 0, 0, 0, 0)
#define TTSP_REF_SPN(spnid, pk_rspn)							cal_svc(SVC_FN_REF_SPN, (spnid), (intptr_t)(pk_rspn), 0, 0, 0)
...
extern ER_UINT svc_ttsp_barrier_sync(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_mp_check_point(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_mp_wait_check_point(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_mp_check_finish(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_state_sync(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_wait_finish_sync(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ttsp_value_sync(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
...
extern ER_UINT svc_ttsp_ref_spn(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
...
extern ER_UINT svc_ttsp_sus_tsk(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
...
extern ER_UINT svc_msta_alm(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_msta_cyc(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_mget_lod(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_mget_nth(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_mact_tsk(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_mig_tsk(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_loc_spn(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_try_spn(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_unl_spn(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
extern ER_UINT svc_ref_spn(intptr_t par1, intptr_t par2, intptr_t par3, intptr_t par4, intptr_t par5, ID cdmid);
 ...
 */ 
extern void ttsp_value_sync(char* proc_id, char* var_name, intptr_t* target_var, intptr_t target_val);
