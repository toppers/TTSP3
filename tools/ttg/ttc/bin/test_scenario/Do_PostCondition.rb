...
#  の責任を負わない．
#
#  $Id: Do_PostCondition.rb 60 2019-12-20 01:14:37Z fujisft-shigihara $
#
...
module CommonModule
  ...
  class Do_PostCondition < Condition
    ...
    def exist_error_code?()
      return (!@hDo[TSR_PRM_ERCD].nil?() || !@hDo[TSR_PRM_ERUINT].nil?() || !@hDo[TSR_PRM_ERBOOL].nil?() || !@hDo[TSR_PRM_BOOL].nil?())  # [Bool]エラーコードが指定されているか
    end
  end
end
