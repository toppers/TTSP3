...
#  の責任を負わない．
#
#  $Id: TestScenario.rb 60 2019-12-20 01:14:37Z fujisft-shigihara $
#
...
module CommonModule
  ...
  class TestScenario
    ...
    def exist_pre_task_pri_chg_fmp()
      return @cPreCondition.exist_pre_task_pri_chg_fmp()  # [Bool]起動時優先度とベース優先度が異なるタスクの有無
    end
    ...
    def gc_pre_lock_mutex_fmp()
      return @cPreCondition.gc_pre_lock_mutex_fmp()  # [IMCodeElement]ミューテックスをロックするコード
    end
    ...
    #=================================================================
    # 概  要: サブ優先度を設定するコードを返す
    #=================================================================
    def gc_pre_set_subpri()
      return @cPreCondition.gc_pre_set_subpri()  # [IMCodeElement]サブ優先度を設定するコードを返すコード
    end
    ...
    #=================================================================
    # 概  要: 割込み要求がある状態の割込みを設定するコードを返す
    #=================================================================
    def gc_pre_interrupt_req_fmp()
      return @cPreCondition.gc_pre_interrupt_req_fmp()  # [IMCodeElement]割込み要求がある状態の割込みを設定するコード
    end
    ...
    def gc_lastpost_interrupt_clr_fmp()
      return @aDo_PostCondition[TTG_IDX_LAST].gc_lastpost_interrupt_clr_fmp()  # [IMCodeElement]割込み要求がある割込みをクリアするコード
    end
