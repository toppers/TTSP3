...
#  の責任を負わない．
#
#  $Id: Overrun.rb 28 2019-02-12 01:50:02Z fujisft-shigihara $
#
require "common/bin/process_unit/ProcessUnit.rb"
require "ttc/bin/process_unit/Overrun.rb"
...
module CommonModule
  #===================================================================
  # クラス名: Overrun
  # 概    要: オーバランハンドラの情報を処理するクラス
  #===================================================================
  class Overrun < ProcessUnit
    #=================================================================
    # 概  要: オーバランハンドラの初期化
    #=================================================================
    def initialize(sObjectID, hObjectInfo, aPath, bIsPre)
      ...
      super(sObjectID, hObjectInfo, TSR_OBJ_OVERRUN, aPath, bIsPre)
    end
    ...
    def gc_config(cElement)
      ...
      cElement.set_config("#{API_DEF_OVR}({#{KER_TA_NULL}, #{@sObjectID.downcase}});", @hState[TSR_PRM_CLASS], @hState[TSR_PRM_DOMAIN])
    end
  end
end
