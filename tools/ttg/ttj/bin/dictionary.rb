...
#  の責任を負わない．
#
#  $Id: dictionary.rb 70 2020-02-04 09:29:02Z fujisft-shigihara $
#
...
module TTJModule
  ...
  GRP_TTJ_VARIATION = {
    ...
    TSR_PRM_SUPPORT_CLR_INT => "APIのclr_int",
    TSR_PRM_SUPPORT_RAS_INT => "APIのras_int",
    TSR_PRM_SUPPORT_PRB_INT => "APIのprb_int"
  }
  ...
  GRP_TTJ_STATUS = {
    ...
    TSR_STT_TRUE => {
      ...
      TSR_PRM_SUPPORT_CLR_INT => "APIのclr_intをサポートする．",
      TSR_PRM_SUPPORT_RAS_INT => "APIのras_intをサポートする．",
      TSR_PRM_SUPPORT_PRB_INT => "APIのprb_intをサポートする．"
    },
    ...
    TSR_STT_FALSE => {
      ...
      TSR_PRM_SUPPORT_CLR_INT => "APIのclr_intをサポートしない．",
      TSR_PRM_SUPPORT_RAS_INT => "APIのras_intをサポートしない．",
      TSR_PRM_SUPPORT_PRB_INT => "APIのprb_intをサポートしない．"
    },
