...
#  の責任を負わない．
#
#  $Id: Condition.rb 35 2019-03-18 06:11:12Z fujisft-shigihara $
#
...
module CommonModule
  ...
  class Condition
    ...
    def japanize_do(sAllDo, sIndent, hVal = nil)
      ...
      elsif (hDoInfo[TSR_PRM_ERBOOL].nil?() == false)  # erbool
        sAllDo += "#{hDoInfo[TSR_PRM_SYSCALL]}を発行し，#{TTJ_NEW_LINE}"
        sAllDo += "#{sIndent}参照結果として#{hDoInfo[TSR_PRM_ERBOOL]}が返る．"
